...
$order = '';
$queryUsers = $pdo->prepare("SELECT * FROM users" . $order);
...
if(!empty($_POST))
{
	...
	{ 
		...
		$insertUser = $pdo->prepare('INSERT INTO users (gender, firstname, lastname, email, birthdate, city) VALUES(:gender, :firstname, :lastname, :email, :birthdate, :city)');
